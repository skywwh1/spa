...
/* @var $searchModel frontend\models\MyCampaignLogHourlySearch */
/* @var $dataProvider yii\data\ActiveDataProvider */
/* @var $form yii\widgets\ActiveForm */

$this->title = 'Hourly report';
$this->params['breadcrumbs'][] = $this->title;
?>
    <div id="nav-menu" data-menu="hourly"></div>
    <div class="row">
        <div class="col-lg-12">
