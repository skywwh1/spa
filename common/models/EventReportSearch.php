...
class EventReportSearch extends LogEventHourly
{
    ...
    public function subDailySearch($params)
    {
        $query = new Query();
        $dataProvider = new ActiveDataProvider([
            'query' => $query,
    ...
    public function subSummarySearch($params)
    {
        $query = new Query();
        $dataProvider = new ActiveDataProvider([
            'query' => $query,
    ...
    public function subDynamicSummarySearch($params)
    {
        $query = LogEventHourly::find();
        // add conditions that should always apply here
        $dataProvider = new ActiveDataProvider([
    ...
    public function subDynamicDailySearch($params)
    {
        $query = LogEventHourly::find();
        // add conditions that should always apply here
        $dataProvider = new ActiveDataProvider([
