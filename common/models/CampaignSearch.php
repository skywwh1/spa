...
//        die();
        ...
        $query->andFilterWhere(['like', 'campaign_name', $this->campaign_name])
            ...
            ->andFilterWhere(['<>', 'advertiser', 83])
            ->andFilterWhere(['<>', 'advertiser', 88])
            ->andFilterWhere(['<>', 'advertiser', 87])
...
//        die();
    ...
    public function mobairSearch($params)
    {
        $query = Campaign::find();
        $query->alias('c');
    ...
    public function clickadSearch($params)
    {
        $query = Campaign::find();
        $query->alias('c');
    ...
    public function otherSearch($params)
    {
        $query = Campaign::find();
        $query->alias('c');
        ...
        $query->andFilterWhere(['like', 'campaign_name', $this->campaign_name])
            ...
            ->andFilterWhere(['like', 'adv_link', $this->adv_link])
            ->andFilterWhere(['like', 'a.username', $this->advertiser])
            ->andFilterWhere(['in', 'advertiser', [26,35, 36,53,59,80,83,87,88]])
            ->andFilterWhere(['like', 'ip_blacklist', $this->ip_blacklist])
            ->andFilterWhere(['in', 'c.id', $this->ids]);
