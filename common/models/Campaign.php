...
class Campaign extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['note'], 'string'],
            [['promote_start', 'promote_end', 'effective_time', 'adv_update_time', 'target_geo', 'advertiser', 'payout_currency', 'device', 'daily_budget', 'daily_cap', 'app_name', 'app_size', 'version', 'app_rate'], 'safe'],
