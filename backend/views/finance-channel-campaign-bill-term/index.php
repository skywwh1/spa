...
$this->title = 'Finance Channel Campaign Bill Terms';
...
<div class="row">
    <div class="col-lg-12">
        <div class="box box-info table-responsive">
            <div class="box-body">
<div class="finance-channel-campaign-bill-term-index">

                <?php // echo $this->render('_search', ['model' => $searchModel]); ?>
    
    <p>
        <?= Html::a('Create Finance Channel Campaign Bill Term', ['create'], ['class' => 'btn btn-success']) ?>
    </p>
                <?= GridView::widget([
