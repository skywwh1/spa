    ...
    <h3>Redirect Option</h3>
        ...
        <div class="form-group field-financededuction-start_date">
            ...
            echo DateTimePicker::widget([
                ...
                'value' => isset($model->start_time) ? date('Y-m-d H:i',$model->start_time + 8*3600) : date('Y-m-d H:i',time() + 8*3600),
                'pluginOptions' => [
                    'autoclose' => true,
            ...
            echo DateTimePicker::widget([
                ...
                'value' => isset($model->end_time) ? date('Y-m-d H:i',$model->end_time + 8*3600)  : date('Y-m-d H:i',time() + 8*3600),
                'pluginOptions' => [
                    'autoclose' => true,
                    'format' => 'yyyy-mm-dd hh:ii',
                    'todayHighlight' => true
