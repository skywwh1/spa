...
<?= Html::activeHiddenInput($model,'is_send',['value'=>0])// $form->field($model, 'is_send')->dropDownList(['1' => 'Yes', '0' => "No"]) ?>
<?= Html::activeHiddenInput($model,'type',['value'=>2])// $form->field($model, 'is_send')->dropDownList(['1' => 'Yes', '0' => "No"]) ?>
