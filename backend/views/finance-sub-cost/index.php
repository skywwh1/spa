...
/* @var $searchModel backend\models\FinanceSubCostSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Finance Sub Costs';
...
<div class="row">
    <div class="col-lg-12">
        <div class="box box-info table-responsive">
            <div class="box-body">
                <div class="finance-sub-cost-index">

                    <?php // echo $this->render('_search', ['model' => $searchModel]); ?>

                    <p>
                        <?= Html::a('Create Finance Sub Cost', ['create'], ['class' => 'btn btn-success']) ?>
                    </p>
                    <?= GridView::widget([
