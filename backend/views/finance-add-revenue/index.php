...
/* @var $searchModel backend\models\FinanceAddRevenueSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Finance Add Revenues';
...
<div class="row">
    <div class="col-lg-12">
        <div class="box box-info table-responsive">
            <div class="box-body">
<div class="finance-add-revenue-index">

                <?php // echo $this->render('_search', ['model' => $searchModel]); ?>
    
    <p>
        <?= Html::a('Create Finance Add Revenue', ['create'], ['class' => 'btn btn-success']) ?>
    </p>
                <?= GridView::widget([
