...
/**
 * FinanceSubRevenueSearch represents the model behind the search form about `backend\models\FinanceSubRevenue`.
 */
class FinanceSubRevenueSearch extends FinanceSubRevenue
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = FinanceSubRevenue::find();
        $query->alias("far");

        // Sub conditions that should always apply here
