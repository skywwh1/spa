...
/**
 * FinanceSubCostSearch represents the model behind the search form about `backend\models\FinanceSubCost`.
 */
class FinanceSubCostSearch extends FinanceSubCost
{
    /**
     * @inheritdoc
     */
